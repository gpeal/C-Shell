 ...
 *
 * arguments:
 *   commandT *cmd: pointer to the commandT strut generated by
 *                  parsing the cmdLine string
 *   char *path:    path to the cmd location or null if it doesn't exist
 *
 * returns: none
 *
 * This function takes a commandT pointer and returns the location of the
 * command that will be executed or null if it doesn't exist
 */
void locateCommand(commandT *cmd, char **path)
{
